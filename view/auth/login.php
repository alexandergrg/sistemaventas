            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center">Ingresa al Sistema</h3>
                    </div>
                          ...
                          <input type="hidden" name="_token" value="<?php csrf_token() ?>">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="micorreo@gmail.com" name="email" type="email" required autocomplete="off" autofocus>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Password" name="password" type="password" value="" required autocomplete="off" >
                                </div>
                                <!--
                                <div class="checkbox">
                                    <label>
